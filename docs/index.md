...
<a href="https://github.com/chrissimpkins/cinder/releases/download/v0.9.3/cinder.zip"><button type="button" class="btn btn-success"><i class="fa fa-cloud-download"></i>  Download Cinder v0.9.3</button></a>
